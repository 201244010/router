            ...
            <div className="preparing">
                ...
                <div className="content">
                    ...
                    <div className='attention'>
                        <div><span>{intl.get(MODULE, 3)/*_i18n:1. 将需要加入网络的路由器接通电源，待系统指示灯*/}</span><CustomIcon size={20} color="rgba(51,60,79,1)" type="Internet"/><span>{intl.get(MODULE, 4)/*_i18n:停止闪烁，即启动完成；*/}</span></div>
