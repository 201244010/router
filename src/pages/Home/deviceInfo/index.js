			...
			},
			{
				...
				render: (text, record) => (
					<div>
						...
						<div>
							<CustomIcon
								className="device-icon-download"
	...
	render() {
		...
		return (
			<div>
				...
				<Button onClick={this.viewDevice} className="button">
					{intl.get(MODULE, 53) /*_i18n:查看设备*/}
				</Button>
				<Modal
					visible={visible}
					width={960}
					...
					footer={[
						<Button key="cancel" onClick={this.handleCancel}>
							{intl.get(MODULE, 16) /*_i18n:取消*/}
						</Button>
					]}
				>
					<div className="deviceInfo-modal-top">
						<p className="modal-top-p">
							{intl.get(MODULE, 49) /*_i18n:上网设备*/} (
							{totalList.length}
							{intl.get(MODULE, 50) /*_i18n:台*/})
						</p>
						<Button
