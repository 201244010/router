...
export default class RouterSetting extends React.PureComponent {
    constructor(props){
        ...
        this.netList = [
            ...
            {route: 'guestWifi', type: 'Guest', color: '#448BE9', content: intl.get(MODULE, 27)/*_i18n:客用Wi-Fi*/},	
        ];

        this.appList = [
            {route: 'flowControl', color: '#3CA8E7', type: 'g', content: intl.get(MODULE, 28)/*_i18n:4G流量控制*/},
