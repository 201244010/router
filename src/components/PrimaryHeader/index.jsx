                    ...
                    </li>
                    {
                        !isGuidePage ? [
                            <nav key="1" className="menu">
                                ...
                                <NavLink to={match.path + "home"} activeClassName="active">{intl.get(MODULE, 0)/*_i18n:首页*/}</NavLink>
                                {/* <Icon type="set"></Icon> */}
                                <NavLink to={match.path + "clientlist"} activeClassName="active">{intl.get(MODULE, 1)/*_i18n:上网设备*/}</NavLink>
                                {/* <Icon type="advancedsetup"></Icon> */}
                                <NavLink to={match.path + "routersetting"} activeClassName="active">{intl.get(MODULE, 2)/*_i18n:路由设置*/}</NavLink>
                            </nav>,
