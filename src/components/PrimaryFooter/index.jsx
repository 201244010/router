    ...
    render() {
        ...
        return (
            <footer className={className}>
                ...
                <p>
                    <span>{intl.get(MODULE, 1)/*_i18n:©2019 上海商米科技有限公司 版权所有*/}</span>|<a href="https://sunmi.com/" target='_blank'>{intl.get(MODULE, 3)/*_i18n:官网*/}</a>|<span>{intl.get(MODULE, 4)/*_i18n:服务热线：400-6666-509*/}</span>
                </p>
            </footer>
        )
    }
